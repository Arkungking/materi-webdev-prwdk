...
function multiply(a: number, b: number = 4) { // <-------- default parameter nya
    console.log(a);
    console.log(b);
...
console.log(multiply(2, )); //<--- kalo argument kosong bakal pake deafult param
...
function getMassage(firstName: string) {  //<------ outer function
    function sayHello() {                       //<------- inner function 
        return "Hello " + firstName + ", ";
    }      
    function welcome () {                       //<-------- inner function
